...
import newTabStudioRouter from "./newtab-studio";
import newTabProjectsRouter from "./newtab-projects";
...
router.use(newTabStudioRouter);
router.use(newTabProjectsRouter);
