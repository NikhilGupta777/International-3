...
| `COPILOT_ULTRA_MODEL` | | `ollama:gpt-oss:120b` | Ultra/default provider-qualified route; mode-specific prompting remains separate |
| `COPILOT_FAST_MODEL` | | `ollama:gpt-oss:120b` | Fast provider-qualified route; Mistral routes follow in the long-context fallback ladder |
