...
$containerEnvironment = @(
  ...
  @{ name = "GEMINI_API_KEY_11"; value = (Get-ConfigValue $envMap "GEMINI_API_KEY_11" "") },
  @{ name = "GEMINI_API_KEY_12"; value = (Get-ConfigValue $envMap "GEMINI_API_KEY_12" "") },
  @{ name = "GEMINI_API_KEY_13"; value = (Get-ConfigValue $envMap "GEMINI_API_KEY_13" "") },
