...
$parameterOverrides = @(
  ...
  "NvidiaApiKey=$(Get-OptionalEnv $envMap 'NVIDIA_API_KEY')"
  "NvidiaApiKey2=$(Get-OptionalEnv $envMap 'NVIDIA_API_KEY_2')"
  "NvidiaApiKey3=$(Get-OptionalEnv $envMap 'NVIDIA_API_KEY_3')"
  "NvidiaApiKey4=$(Get-OptionalEnv $envMap 'NVIDIA_API_KEY_4')"
  "MistralApiKey=$(Get-OptionalEnv $envMap 'MISTRAL_API_KEY')"
  "SambaNovaApiKey=$(Get-OptionalEnv $envMap 'SAMBANOVA_API_KEY')"
  "OpenRouterApiKey=$(Get-OptionalEnv $envMap 'OPENROUTER_API_KEY')"
  "AionApiKey=$(Get-OptionalEnv $envMap 'AION_API_KEY')"
  "KiloApiKey=$(Get-OptionalEnv $envMap 'KILO_API_KEY')"
  "CopilotUltraModel=$(Get-OptionalEnv $envMap 'COPILOT_ULTRA_MODEL' 'mistral:mistral-medium-latest')"
  "CopilotFastModel=$(Get-OptionalEnv $envMap 'COPILOT_FAST_MODEL' 'mistral:mistral-small-latest')"
  "CopilotUltraMaxOutputTokens=$(Get-OptionalEnv $envMap 'COPILOT_ULTRA_MAX_OUTPUT_TOKENS' '60000')"
  "CopilotFastMaxOutputTokens=$(Get-OptionalEnv $envMap 'COPILOT_FAST_MAX_OUTPUT_TOKENS' '60000')"
  ...
  "LambdaClipMaxDurationSeconds=$(Get-OptionalEnv $envMap 'LAMBDA_CLIP_MAX_DURATION_SECONDS' '420')"
