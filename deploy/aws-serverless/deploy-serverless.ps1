...
$parameterOverrides = @(
  ...
  "CopilotUltraModel=$(Get-OptionalEnv $envMap 'COPILOT_ULTRA_MODEL' 'z-ai/glm-5.2')"
  "CopilotFastModel=$(Get-OptionalEnv $envMap 'COPILOT_FAST_MODEL' 'openai/gpt-oss-120b')"
