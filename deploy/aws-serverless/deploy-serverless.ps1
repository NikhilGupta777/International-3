...
$parameterOverrides = @(
  ...
  "CopilotVertexBrokerUrl=$(Get-OptionalEnv $envMap 'COPILOT_VERTEX_BROKER_URL')"
  "CopilotVertexBrokerSecret=$(Get-OptionalEnv $envMap 'COPILOT_VERTEX_BROKER_SECRET')"
  "CopilotUltraVertexEnabled=$(Get-OptionalEnv $envMap 'COPILOT_ULTRA_VERTEX_ENABLED' 'false')"
