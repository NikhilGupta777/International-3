...
$parameterOverrides = @(
  ...
  "TranslatorBatchJobQueue=$(Get-OptionalEnv $envMap 'TRANSLATOR_BATCH_JOB_QUEUE' 'ytgrabber-green-translator-cpu-queue')"
  "TranslatorBatchJobDefinition=$(Get-OptionalEnv $envMap 'TRANSLATOR_BATCH_JOB_DEFINITION' 'ytgrabber-green-translator-cpu-job')"
