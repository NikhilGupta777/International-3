...
$parameterOverrides = @(
  ...
  "CopilotUltraModel=$(Get-OptionalEnv $envMap 'COPILOT_ULTRA_MODEL' 'ollama:gpt-oss:120b')"
  "CopilotFastModel=$(Get-OptionalEnv $envMap 'COPILOT_FAST_MODEL' 'ollama:gpt-oss:120b')"
